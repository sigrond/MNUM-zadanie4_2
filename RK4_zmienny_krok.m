...
%RK4_zmienny_krok Metoda Rungego-Kutty czwartego rzêdu ze zmiennym krokiem
...
%   ni¿ wczeœniej ze wzglêdu na zmienny krok
%   errx - b³¹d rozwi¹zania
%   t - czas obliczeñ
tic;
yn=x0;%y0
krok=0.001;
alpha=1;%wspó³czynnik korekcji kroku
epsylon=1e-3;%dok³adnoœæ obliczeñ
epsylonWzg=1e-3;%dok³adnoœæ wzglêdna
epsylonBezWzg=1e-6;%dok³adnoœæ bezwzglêdna
s=0.9;
beta=5;
maxiter=1e4;
h=krok;
